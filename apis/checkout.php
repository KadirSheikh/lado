          ...
          <table border="1" class="m-auto">
            <tbody>
              ...
              <tr>
                ...
                <td><label>CUTOMER ID : </label></td>
                <td><input readonly id="CUST_ID" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="'.$user_id.'"></td>
              </tr>
              <tr>
                
                <td><label>INDUSTRY ID : </label></td>
              ...
              <tr>
                ...
                <td>Proceed</td>
                <td><input value="Proceed Checkout" class="btn btn-primary ml-5" type="submit"	onclick="" style="background-color:#3F51B5 !important;"></td>
              </tr>
            </tbody>
          </table>';
