                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3" style="width: 100%">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../assets/images/products/<?php echo $row['image']; ?>" class="card-img"
                                    style="width: 20rem;height: 20rem;max-width: auto;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><a href="orders.php"><button
                                                class="btn btn-danger">Back</button></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
