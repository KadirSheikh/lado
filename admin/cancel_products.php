...
<head>
    ...
    <title>LADO | Cancelled Products</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Cancel Products</h1>
                                ...
                                <div class="card-header">
                                    <div class="row mb-0">
                                        <div class="col-10 col-sm-10" data-toggle="collapse"
                                            ...
                                            <h6> <b>Order ID:</b> <?php echo $row['order_id']; ?> |<b>Product ID:</b>
                                                <?php echo $row['product_id']; ?> | <b>Quantity:
                                                </b>
                                                <?php echo $row['product_quantity']; ?> | <b>Total: </b> Rs.
                                                <?php echo $row['total_price']; ?> |
                                                <b>Status:</b>Canceled by user
                                            </h6>
                                        </div>
...
$check_query = "SELECT * FROM order_tbl WHERE `cancel_request` = 1";
$result = mysqli_query($conn , $check_query);
$count = mysqli_num_rows($result);

if($count == 0){
  echo "<script>
  $('.is_data_empty').html('<h3>No canceled order found.</h3>');
